...
public class createModule {
	...
	private void initialize() {
		...
		label_5.setBounds(141, 24, 63, 14);
		group.add(label_5);
		
		JSpinner spinner_1 = new JSpinner();
		spinner_1.setBounds(90, 21, 42, 20);
		group.add(spinner_1);
		
		JLabel label_6 = new JLabel("\u0633\u0627\u0639\u062A");
		label_6.setBounds(34, 24, 46, 14);
		group.add(label_6);
		
		JLabel label_7 = new JLabel("\u062A\u0639\u062F\u0627\u062F \u0627\u0641\u0631\u0627\u062F:");
		label_7.setBounds(348, 24, 63, 14);
		group.add(label_7);
		
		JSpinner spinner_2 = new JSpinner();
		spinner_2.setBounds(296, 21, 42, 20);
		group.add(spinner_2);
		
		JLabel label_8 = new JLabel("\u0646\u0641\u0631");
		label_8.setBounds(250, 24, 35, 14);
		group.add(label_8);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBorder(new TitledBorder(null, "\u0645\u0646\u0627\u0628\u0639 \u0627\u0646\u0633\u0627\u0646\u06CC", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_1.setBounds(221, 66, 190, 185);
		group.add(panel_1);
		panel_1.setLayout(null);
		
		table_1 = new JTable();
		table_1.setBounds(179, 28, -164, 132);
		panel_1.add(table_1);
		...
		panel_2.setBounds(21, 66, 190, 185);
		group.add(panel_2);
